...
package com.ftinc.kit.ui.attributr.internal;

import android.content.Context;
import android.support.annotation.XmlRes;

import com.ftinc.kit.ui.attributr.model.Library;
import com.ftinc.kit.ui.attributr.model.License;
...
public final class Parser {
     ...
     */
    public static List<Library> parse(Context ctx, @XmlRes int license){
    ...
    private static Library readLibrary(XmlPullParser parser) throws IOException, XmlPullParserException {
        ...
        lib.license = License.fromKey(license);
