...
class ForegroundLinearLayout : LinearLayout {
    ...
    constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(context, attrs, defStyle) {
        ...
        val a = context.obtainStyledAttributes(attrs, R.styleable.ForegroundLinearLayout,
                defStyle, 0)

        mForegroundGravity = a.getInt(
                R.styleable.ForegroundLinearLayout_android_foregroundGravity, mForegroundGravity)

        val d = a.getDrawable(R.styleable.ForegroundLinearLayout_android_foreground)
        if (d != null) {
            foreground = d
        }
